...
USPersonalExpenditure$category[USPersonalExpenditure$X1960 == max(USPersonalExpenditure$X1960)]

# Define a function `DetectHighest` that takes in a year as a parameter, and
# returns the highest spending category of that year
DetectHighest <- function(year) {
  return( USPersonalExpenditure$category[USPersonalExpenditure[, year] == max(USPersonalExpenditure[, year])] )
...
USPersonalExpenditure$category[USPersonalExpenditure[, "X1955"] == max(USPersonalExpenditure[, "X1955"])]
